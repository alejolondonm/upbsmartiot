...
void loop()
{
    ...
    // Empaquetar datos
    String jsonData = "alejolondonm${\"lat\": {\"value\":" + String(gps.location.lat(), 6) + "} ,\"lon\": {\"value\":" + String(gps.location.lng(), 6) + "} , \"temp\": {\"value\":" + String(promedio_temp) + "} ,\"humedad\": {\"value\":" + String(promedio_hum) + "}}";
